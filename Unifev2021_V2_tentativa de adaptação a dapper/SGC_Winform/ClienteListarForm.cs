...
namespace SGC_Winform
{
    public partial class ClienteListarForm : Form
    {
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var excluiu = new ClienteBusiness().Excluir(Convert.ToInt32(obj));
                if (excluiu)
        ...
        private void buscarButton_Click(object sender, EventArgs e)
        {
            ...
            else if (dados.Rows.Count == 1)
            {
                quantidadeLabel.Text = "1 registro foi encontrado!";
            }
            else if (dados.Rows.Count > 1)
            {
                quantidadeLabel.Text = dados.Rows.Count.ToString() + " registros foram encontrados!";
            }
        ...
        private void alterarButton_Click(object sender, EventArgs e)
        {
            ...
            //seleciona o registro do grid
            int id = 0;
            try { id = Convert.ToInt32(listaDataGridView.SelectedRows[0].Cells["idColumn"].Value); }
            catch
            {
                MessageBox.Show("Selecione um registro válido no grid.");
                return;
            ...
            new ClienteInserirAlterarForm(id).ShowDialog();
